...
[^16]: [Stop Validating Everywhere: An Architectural Guide to Error Handling in TypeScript]({{< relref "/post/typescript-stop-validating-everywhere" >}})
[^17]: [Stop Validating Everywhere: An Architectural Guide to Error Handling in Python]({{< relref "/post/python-stop-validating-everywhere" >}})
